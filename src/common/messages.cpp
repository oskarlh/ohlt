...
static MessageTable_t const assumes[assume_last] = {
	{		   "invalid assume message",
	  "This is a message should never be printed.",																														   contact																																							},

	// generic
	{		"Memory allocation failure",
	  "The program failled to allocate a block of memory.",			"Likely causes are (in order of likeliness) : the partition holding the swapfile is full; swapfile size is smaller than required; memory fragmentation; heap corruption"																								   },
	...
	{			  "No visibile brushes",
	  "All brushes are CLIP or ORIGIN (at least one must be normal/visible)",																																									 selfexplanitory																				},
	...
	{	  "Exceeded MAX_SWITCHED_LIGHTS",
	  "The maximum number of switchable light entities has been reached",																																									 selfexplanitory																					},
	...
	{			   "Empty Solid Entity",
	  "A solid entity in the map (func_wall for example) has no brushes.",																							  "If using Worldcraft, do a check for problems and fix any occurences of 'Empty solid'"																					 },
	...
	{			"Malformed face normal",
	  "The texture alignment of a visible face is unusable",																	   "If using Worldcraft, do a check for problems and fix any occurences of 'Texture axis perpindicular to face'"																									},
	{					   "No Lights!",
	  "lighting of map halted (I assume you do not want a pitch black map!)",																																					   "Put some lights in the map."																				},
	...
	{		  "Exceeded MAX_MAP_PLANES",
	  "The maximum number of plane definitions has been reached",																																					 "The map has grown too complex"																							},
	{		"Exceeded MAX_MAP_TEXTURES",
	  "The maximum number of textures for a map has been reached",																																									 selfexplanitory																						   },

	{		  "Exceeded MAX_MAP_MIPTEX",
	  "Texture memory usage on the map has exceeded the limit",																													   "Merge similar textures, remove unused textures from the map"																							  },
	{		 "Exceeded MAX_MAP_TEXINFO",																									 internallimit,																																											 contact },
	{		   "Exceeded MAX_MAP_SIDES",																									 internallimit,																																											 contact },
	{		 "Exceeded MAX_MAP_BRUSHES",
	  "The maximum number of brushes for a map has been reached",																																									 selfexplanitory																							},
	...
	{		  "Exceeded MAX_MAP_MODELS",
	  "The maximum number of brush based entities has been reached",																							  "Remove unnecessary brush entities, consolidate similar entities into a single entity"																						 },
	{		   "Exceeded MAX_MAP_VERTS",
	  "The maximum number of vertices for a map has been reached",																																											simplify																						   }, // internallimit, contact //--vluzacn
	...
	{		   "Exceeded MAX_MAP_FACES",
	  "The maximum number of faces for a map has been reached",																   "This error is typically caused by having a large face with a small texture scale on it, or overly complex maps."																								},
	{	   "Exceeded MAX_MAP_SURFEDGES",																									 internallimit,																																											 contact },
	{		   "Exceeded MAX_MAP_NODES",
	  "The maximum number of nodes for a map has been reached",																																											simplify																							  },
	{			 "CompressVis Overflow",																									 internalerror,																																											 contact },
	{		   "DecompressVis Overflow",																									 internalerror,																																											 contact },
	{		   "Exceeded MAX_MAP_LEAFS",
	  "The maximum number of leaves for a map has been reached",																																											simplify																							 },
	{			  "Execution Cancelled",
	...
	{		"Exceeded MAX_MAP_LIGHTING",
	  "You have run out of light data memory",																																			 "It might be caused by a compiler bug."																											   },
