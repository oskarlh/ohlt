...
static const MessageTable_t assumes[assume_last] = {
	...
	{"Exceeded MAX_MAP_LIGHTING","You have run out of light data memory" ,"It might be caused by a compiler bug."},
	...
	{"Couldn't open extent file", "<mapname>.ext doesn't exist. This file is required by the " PLATFORM_VERSION " version of hlrad.", "Make sure hlbsp has run correctly. Alternatively, run 'ripent.exe -writeextentfile <mapname>' to create the extent file."},
}; 
