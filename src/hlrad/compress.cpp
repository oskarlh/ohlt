...
void vector_compress
	(vector_type t, void *s, float f1, float f2, float f3)
{
	unsigned int *m = (unsigned int *)s;
	const unsigned int p1 = std::bit_cast<unsigned int>(f1);
	const unsigned int p2 = std::bit_cast<unsigned int>(f2);
	const unsigned int p3 = std::bit_cast<unsigned int>(f3);
	...
	case vector_type::vector24:
		...
		else
		{
			...
			i1 = float_istoobig (p1)? ~0u : (bitget (p1, 0, 23) | bitput (1, 23)) >> ((1 + max - bitget (p1, 23, 31)) % 32);
	...
	(vector_type t, const void *s, float *f1, float *f2, float *f3)
{
	...
	case vector_type::vector24:
		...
		if (t == vector_type::vector32)
		{
			*p1
				= bitput (1, 13)
				| bitput (bitget (m[0], 0, 9), 14)
				| bitput (bitget (m[0], 27, 32), 23)
				| bitput (3, 28)
				;
			*p2
				= bitput (1, 13)
				| bitput (bitget (m[0], 9, 18), 14)
				| bitput (bitget (m[0], 27, 32), 23)
				| bitput (3, 28)
				;
			*p3
				= bitput (1, 13)
				| bitput (bitget (m[0], 18, 27), 14)
				| bitput (bitget (m[0], 27, 32), 23)
				| bitput (3, 28)
				;
			*((unsigned int *)&f)
		...
		else
		{
			*p1
				= bitput (1, 16)
				| bitput (bitget (m[0], 0, 6), 17)
				| bitput (bitget (m[0], 18, 23), 23)
				| bitput (3, 28)
				;
			*p2
				= bitput (1, 16)
				| bitput (bitget (m[0], 6, 12), 17)
				| bitput (bitget (m[0], 18, 23), 23)
				| bitput (3, 28)
				;
			*p3
				= bitput (1, 16)
				| bitput (bitget (m[0], 12, 18), 17)
				| bitput (bitget (m[0], 18, 23), 23)
				| bitput (3, 28)
				;
			*((unsigned int *)&f)
